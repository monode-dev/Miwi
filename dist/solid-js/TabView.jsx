...
export function TabView(props) {
    ...
    onMount(() => {
        ...
        let lastSwipeX = 0;
        let lastSwipeY = 0;
        tabBodiesParent?.addEventListener("touchstart", (e) => {
        ...
        tabBodiesParent?.addEventListener("touchmove", (e) => {
            const touch = e.touches[0];
            lastSwipeX = touch.clientX;
            lastSwipeY = touch.clientY;
        });
        tabBodiesParent?.addEventListener("touchend", (e) => {
    ...
    return (<Row ref={tabBodiesParent} width="300%" onClick={props.onClick} sty={{
            height: grow(),
