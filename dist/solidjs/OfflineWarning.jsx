...
export function OfflineWarning(props) {
    ...
    // >
    props.isOnline.value ? undefined : (<div style={{
        ...
        <Box width={`100%`} height={`100%`} pad={1} align={$Align.bottomLeft}>
          <Row background={$theme.colors.warning} textColor={$theme.colors.accent} cornerRadius={1} shadowDirection={$Align.center} shadowSize={2} pad={0.5}>
